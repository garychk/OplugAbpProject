...
{
    [Table("JobOper")]
    public partial class JobOper : Entity<Guid>, IMustHaveTenant
    {
        [Required]
        [StringLength(8)]
        ...
        public decimal RptBillableLaborRate { get; set; }

        public decimal RptBillableUnitPrice { get; set; }

        public decimal RptLaborRate { get; set; }
